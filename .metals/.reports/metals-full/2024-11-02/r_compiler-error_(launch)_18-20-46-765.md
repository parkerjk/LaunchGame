...
### scala.reflect.internal.FatalError: 
  ...
  last tree to typer: Ident(x$1)
       tree position: line 38 of file:///C:/Users/parke/OneDrive/Desktop/Launch/launch/src/main/scala/Main.scala
            tree tpe: <error>
              symbol: value x$1
...
== Source file context for tree position ==
    ...
    35   // Method to update game logic
    36   def updateGame(): Unit = {
    37     // Update positions, check collisions, and handle game state
    38     projectil_CURSOR_e.foreach(_.update())
    39     targets.foreach(_.checkCollision(projectiles))
    40     // Check for game over conditions
    41   }
