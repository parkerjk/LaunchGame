...
### scala.reflect.internal.FatalError: 
  ...
  last tree to typer: Ident(x$1)
       tree position: line 43 of file:///C:/Users/parke/OneDrive/Desktop/Launch/launch/src/main/scala/Main.scala
            tree tpe: <error>
              symbol: value x$1
   symbol definition: x$1: <error> (a TermSymbol)
      symbol package: <empty>
       symbol owners: value x$1 -> value $anonfun -> method updateGame -> object LaunchGame
           call site: <none> in <none>

== Source file context for tree position ==

    40   // Method to update game logic
    41   def updateGame(): Unit = {
    42     // Update positions, check collisions, and handle game state
    43     _CURSOR_projectiles.foreach(_.update())
    44     targets.foreach(_.checkCollision(projectiles))
    45     // Check for game over conditions
    46   }
...
object LaunchGame extends JFXApp {
  ...
  var potatoes: List[Projectile] = List()
  ...
  def updateGame(): Unit = {
    ...
    targets.foreach(_.checkCollision(projectiles))
