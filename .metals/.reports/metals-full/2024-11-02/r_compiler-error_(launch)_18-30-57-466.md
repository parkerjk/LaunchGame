...
### scala.reflect.internal.FatalError: 
  ...
  last tree to typer: Ident(_CURSOR_projectiles)
       tree position: line 36 of file:///C:/Users/parke/OneDrive/Desktop/Launch/launch/src/main/scala/Main.scala
            tree tpe: <error>
...
== Source file context for tree position ==
    ...
    33   def launchProjectile(x: Double, y: Double): Unit = {
    34     // Create and add a new projectile to the game
    35     val newProjectile = new Projectile(x, y) // Placeholder constructor
    36     _CURSOR_projectiles = newProjectile :: projectiles
    37     // Additional logic to handle projectile launch
    38   }
    39 
